package com.zuyatna.storyapp.data.remote
...
import com.zuyatna.storyapp.data.local.database.RemoteKeys
...
import com.zuyatna.storyapp.utils.wrapEspressoIdlingResource
...
class StoryRemoteMediator(
    ...
    override suspend fun load(
        ...
        wrapEspressoIdlingResource {
            try {
                val responseData = apiService.getStories(userAuth, page, state.config.pageSize)

                val endOfPaginationReached = responseData.body()!!.storyModel.isEmpty()
